...
**Phase 1** (Now): ZIP export + QR with instructions
**Phase 2** (Next): Hosted PWAs with instant links  
**Phase 3** (Future): Offline Whisper + P2P sharing

---

**The Dream**: Every button you design becomes its own tiny app that lives on your phone and works forever. Share it like sharing a photo. No app stores, no friction, just buttons that work.