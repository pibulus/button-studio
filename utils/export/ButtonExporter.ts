  ...
  title: {
    ...
    marginBottom: 40,
      ...
      },
      {
        path: "README.md",
        content:
          `# ${config.appName}\n\nReact Native button app generated by ButtonSpa.\n\n## Setup\n\n1. npm install\n2. npx react-native run-ios (or run-android)\n3. Voice transcription calls buttonspa.app's transcribe endpoint — no API key needed on device. Point VoiceButton at your own backend if you want to self-host transcription instead.`,
      },
    ];
  }
...
2. Run: npm install
3. Voice transcription calls buttonspa.app's transcribe endpoint by default — no API key needed. Swap in your own backend if you want to self-host it.
