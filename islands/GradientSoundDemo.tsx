    ...
    <div class="p-6 bg-gray-900 rounded-lg">
      ...
      {!packLoaded.value ? (
        <div class="text-center py-12">
          <div class="text-2xl text-purple-400 mb-2">Loading Sound Pack...</div>
          <div class="text-gray-400">Initializing Kenney Interface Sounds</div>
        </div>
      ) : (
        <>
          {/* Gradient Buttons */}
          <div class="space-y-6">
            ...
            <div class="mt-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
              ...
              <p class="text-gray-400 text-xs mt-2">
                Using the modular SoundPack system with Web Audio API for real-time pitch shifting.
              </p>
            </div>

            {/* Pack Info */}
            <div class="mt-4 p-4 bg-purple-900/20 border border-purple-500/30 rounded-lg">
              <h4 class="text-purple-400 font-bold mb-2">📦 Sound Pack Info:</h4>
              <p class="text-gray-300 text-sm">
                <strong>Pack:</strong> {kenneyManifest.name} v{kenneyManifest.version}<br/>
                <strong>Author:</strong> {kenneyManifest.author}<br/>
                <strong>License:</strong> {kenneyManifest.license}<br/>
