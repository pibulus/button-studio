...
export default function VoiceButtonStudio() {
  ...
  function surpriseMe() {
    ...
    if (usePreset) {
      ...
      const randomPreset =
        beautifulPresets[Math.floor(Math.random() * beautifulPresets.length)];
      buttonConfig.value = {
        ...randomPreset,
      };
      ...
      buttonConfig.value = {
        ...
        shape: {
          type: randomShape,
          borderRadius: randomShape === "circle"
            ? 50
    ...
    children: [
      ...
      /*#__PURE__*/ _jsx("section", {
        ...
        children: /*#__PURE__*/ _jsxs("div", {
          class:
            "bg-soft-paper rounded-3xl shadow-soft-card p-12 text-center border border-soft-mist/30",
          children: [
            /*#__PURE__*/ _jsxs("div", {
            ...
            /*#__PURE__*/ _jsx("div", {
              ...
              children: /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                  ...
                  /*#__PURE__*/ _jsx("div", {
                    class:
                      "absolute inset-0 bg-gradient-to-r from-soft-peach/20 to-soft-coral/20 rounded-full blur-xl -z-10 scale-150",
                  }),
                ],
              }),
            }),
            /*#__PURE__*/ _jsxs("div", {
              ...
              children: [
                /*#__PURE__*/ _jsx("button", {
                  onClick: surpriseMe,
                  class:
                    "flex-1 bg-gradient-to-r from-soft-peach to-soft-coral text-white font-bold px-8 py-4 rounded-2xl shadow-button-surprise hover:shadow-chonky-hover hover:scale-[1.02] transition-all duration-200 text-lg",
                  children: "🎲 Roll the vibe dice",
                }),
                /*#__PURE__*/ _jsx("button", {
                  onClick: copyButtonCode,
                  class:
                    "flex-1 bg-gradient-to-r from-soft-sunset to-soft-mint text-soft-charcoal font-bold px-8 py-4 rounded-2xl shadow-button-primary hover:shadow-chonky-hover hover:scale-[1.02] transition-all duration-200 text-lg",
      ...
      /*#__PURE__*/ _jsxs("section", {
        ...
        children: [
          /*#__PURE__*/ _jsxs("div", {
            class:
              "bg-soft-paper rounded-3xl shadow-soft-card p-8 border border-soft-mist/30",
            children: [
              /*#__PURE__*/ _jsxs("div", {
                      ...
                      /*#__PURE__*/ _jsx("div", {
                        ...
                        children: [
                          ...
                          /*#__PURE__*/ _jsxs("button", {
                            ...
                            class:
                              `p-4 rounded-2xl font-bold capitalize text-lg transition-all border-2 hover:scale-[1.02] ${
                      ...
                      /*#__PURE__*/ _jsx("div", {
                        ...
                        children: [
                          ...
                          /*#__PURE__*/ _jsxs("button", {
                            ...
                            class:
                              `p-4 rounded-2xl font-bold text-lg transition-all border-2 hover:scale-[1.02] ${
                                Math.abs(buttonConfig.value.size.width - size) <
                                    20
                                  ? "border-soft-glow bg-soft-glow/10 text-soft-glow shadow-soft-glow"
                                  : "border-soft-mist bg-white text-soft-slate hover:border-soft-peach"
                              }`,
          ...
          /*#__PURE__*/ _jsxs("div", {
            class:
              "bg-soft-paper rounded-3xl shadow-soft-card border border-soft-mist/30 overflow-hidden",
            children: [
              /*#__PURE__*/ _jsx("button", {
                onClick: () => showAdvanced.value = !showAdvanced.value,
                class:
                  "w-full p-8 text-left hover:bg-soft-mist/20 transition-colors",
                children: /*#__PURE__*/ _jsxs("div", {
              ...
              showAdvanced.value && /*#__PURE__*/ _jsxs("div", {
                class:
                  "px-8 pb-8 border-t border-soft-mist/30 animate-slide-down",
                children: [
                  /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
      /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
          ...
          /*#__PURE__*/ _jsxs("span", {
            class:
              "text-soft-glow font-black text-xl bg-soft-glow/10 px-3 py-1 rounded-xl",
            children: [
              value,
              unit,
            ],
      ...
      /*#__PURE__*/ _jsx("div", {
        ...
        children: /*#__PURE__*/ _jsx("input", {
          ...
          class:
            "w-full h-4 bg-soft-mist rounded-xl appearance-none cursor-pointer slider-soft focus:outline-none",
          style:
            "background: linear-gradient(to right, #ff6b9d 0%, #ff6b9d calc(var(--value) * 1%), #f8f4f0 calc(var(--value) * 1%), #f8f4f0 100%); --value: var(--value, 50);",
        }),
      }),
    ],
  });
