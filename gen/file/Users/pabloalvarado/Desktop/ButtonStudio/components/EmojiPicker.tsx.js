  ...
  return /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
      /*#__PURE__*/ _jsxs("button", {
        ...
        class:
          "w-full p-3 border-3 border-flamingo-primary rounded-chunky font-chunky text-center text-lg focus:outline-none focus:border-flamingo-purple hover:border-flamingo-purple transition-colors flex items-center justify-between",
        children: [
          /*#__PURE__*/ _jsx("span", {
            class: "text-2xl",
      ...
      isOpen.value && /*#__PURE__*/ _jsx("div", {
        class:
          "absolute top-full left-0 right-0 mt-2 bg-white border-3 border-flamingo-primary rounded-chunky shadow-lg z-50 max-h-80 overflow-y-auto",
            ...
            Object.entries(emojiCategories).map(([categoryName, emojis]) =>
              /*#__PURE__*/ _jsxs("div", {
                children: [
                  /*#__PURE__*/ _jsx("h4", {
                    class:
                      "text-xs font-chunky text-flamingo-charcoal mb-2 uppercase tracking-wide",
                  ...
                  /*#__PURE__*/ _jsx("div", {
                    ...
                    children: emojis.map((emoji) =>
                      /*#__PURE__*/ _jsx("button", {
                        ...
                        class:
                          "w-8 h-8 flex items-center justify-center text-lg hover:bg-flamingo-cream rounded-md transition-colors",
                        title: emoji,
                        children: emoji,
                      }, emoji)
                    ),
            ...
            /*#__PURE__*/ _jsxs("div", {
              ...
              children: [
                ...
                /*#__PURE__*/ _jsx("input", {
                  ...
                  class:
                    "w-full p-2 border-2 border-flamingo-concrete rounded-md text-sm focus:outline-none focus:border-flamingo-purple",
                  onKeyDown: (e) => {
                    if (e.key === "Enter") {
