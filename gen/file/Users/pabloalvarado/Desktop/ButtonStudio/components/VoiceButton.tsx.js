...
export default function VoiceButton({
  ...
  const getThemeClasses = () => {
    const baseClasses =
      "relative overflow-hidden transition-all duration-300 ease-out focus:outline-none font-chunky tracking-chunky";
    ...
    const sizeStyle =
      `width: ${config.size.width}px; height: ${config.size.height}px;`;
    // Calculate font size based on button size (auto-scaling)
    const fontSize = config.content.autoScale
      ? Math.max(12, Math.min(48, config.size.width * 0.25))
      : 20;
    ...
    if (config.appearance.fill.type === "gradient") {
      ...
      if (grad.type === "linear") {
        backgroundStyle = `background: linear-gradient(${grad.direction}deg, ${
          grad.colors[0]
        }, ${grad.colors[1]});`;
      } else {
    ...
    if (shadow.type !== "none") {
      if (shadow.type === "glow") {
        shadowStyle =
          `box-shadow: 0 0 ${shadow.blur}px ${shadow.spread}px ${shadow.color};`;
        ...
        shadowStyle =
          `box-shadow: ${shadow.x}px ${shadow.y}px 0px ${shadow.spread}px ${shadow.color};`;
      }
    }
    ...
    const combinedStyle =
      `${sizeStyle} ${fontSizeStyle} ${borderRadiusStyle} ${backgroundStyle} ${borderStyle} ${shadowStyle}`;
    return {
  ...
  return /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
      showWaveform && buttonState.value === "recording" && /*#__PURE__*/
      _jsx("div", {
        class: `w-full p-6 shadow-md ${
      ...
      /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
          ...
          /*#__PURE__*/ _jsx("button", {
            ...
            title: getButtonText(),
            children: buttonState.value === "recording" && showTimer
              ? /*#__PURE__*/ _jsx("div", {
      ...
      /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
          /*#__PURE__*/ _jsx("p", {
            class: `text-xl font-chunky tracking-wide ${
              theme === "flamingo-brutalist"
          ...
          showTimer && buttonState.value === "recording" && /*#__PURE__*/
          _jsx("p", {
      ...
      transcript.value && /*#__PURE__*/ _jsx("div", {
        ...
        children: /*#__PURE__*/ _jsx("div", {
          class:
            `w-full whitespace-pre-line p-8 font-mono text-base leading-relaxed shadow-lg ${
              theme === "flamingo-brutalist"
